...
export function getEmailConfig(): EmailConfig {
  ...
  const base: EmailConfig = {
    ...
    company: {
      ...
      supportEmail: process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'support@transport-erp.com',
      billingEmail: process.env.NEXT_PUBLIC_BILLING_EMAIL || 'billing@transport-erp.com',
    },
    sending: {
      enabled: false,
      maxRetries: 3,
