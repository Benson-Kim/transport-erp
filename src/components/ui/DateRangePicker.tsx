    ...
    return (
        <div className={cn("relative inline-block", className)} ref={dropdownRef}>
            <Button
                ...
                type="button"
                variant="ghost"
                icon={<Calendar className={cn("h-4 w-4", hasValue ? "text-primary-600" : "text-neutral-400")} />}
                            ...
                            <div className="space-y-4 w-80">
                                ...
                                {localFrom && localTo && (
                                    <div className="p-2 bg-neutral-50 rounded-lg text-xs text-neutral-600">
                                        {(() => {
                                            const days = Math.ceil((new Date(localTo).getTime() - new Date(localFrom).getTime()) / (1000 * 60 * 60 * 24)) + 1;
