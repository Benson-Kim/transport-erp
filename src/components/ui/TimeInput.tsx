...
export interface TimeInputProps extends Omit<InputHTMLAttributes<HTMLInputElement>, 'type' | 'size'> {
  size?: ComponentSize;
  error?: string;
  format?: '12' | '24';
  showSeconds?: boolean;
...
export const TimeInput = forwardRef<HTMLInputElement, TimeInputProps>(
  (
    ...
    const placeholder = showSeconds 
      ? (format === '12' ? 'HH:MM:SS AM/PM' : 'HH:MM:SS')
      : (format === '12' ? 'HH:MM AM/PM' : 'HH:MM');
