...
export const ServiceRow = memo(function ServiceRow({
    ...
    const menuItems = [
        ...
        canGenerateInvoice && {
            ...
            tooltip: service.status !== ServiceStatus.COMPLETED
        ...
        <>
            <tr
                className={cn(
                    ...
                    index % 2 === 1 && !isSelected && !isHovered && "bg-neutral-50/50 dark:bg-neutral-900/50",
                )}
            ...
            >
                {/* Checkbox */}
                <td className="sticky left-0 z-10 bg-white dark:bg-neutral-950 p-3 w-12" data-no-row-click>
                    <Checkbox
                        checked={isSelected}
                        onCheckedChange={() => { }}
                        onClick={onSelect}
                                ...
                                <dl className="space-y-1 text-sm">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div>
                                            ...
                                            <dd className="font-medium">{service.origin} → {service.destination}</dd>
                                        </div>
                                    </div>
                                </dl>
                            </div>
                            ...
                            <div>
                                ...
                                <dl className="space-y-1 text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <dd>{service.createdAt && format(new Date(service.createdAt), 'dd MMM yyyy HH:mm')}</dd>
                                    </div>
                                    <div className="flex justify-between">
                                        <dt className="text-muted-foreground">Updated:</dt>
                                        <dd>{service.updatedAt && format(new Date(service.updatedAt), 'dd MMM yyyy HH:mm')}</dd>
                                    </div>
                                </dl>
                            </div>
