...
export default function PDFSettings() {
    ...
    const dimensions = paperDimensions[paperSize as keyof typeof paperDimensions] || paperDimensions.A4;
                        ...
                        <div className="bg-neutral-50 rounded-lg p-4 flex items-center justify-center w-full">
                            <div
                                ...
                                style={{
                                    ...
                                    height: paperSize === 'Legal' ? '140px' : (paperSize === 'Letter' ? '110px' : '118px'),
                                }}
                            >
