...
export default function BackupSettings() {
    ...
    async function loadLastBackup() {
        try {
            const timestamp = await getLastBackupTime();
            setLastBackup(timestamp?.timestamp ?? null);
        } catch (error) {
    ...
    const estimatedSize = retentionDays * (frequency === 'daily' ? 1 : frequency === 'weekly' ? 0.14 : 0.03);
    ...
    return (
        <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className={cn(
                        ...
                        <div className="flex items-start gap-3">
                            <div className={cn(
                                "p-2 rounded-lg",
                                lastBackup ? "bg-green-100" : "bg-neutral-200"
                            )}>
                                {lastBackup ? (
            ...
            <div>
                ...
                <FormField label="Enable Automatic Backups"
                    className="mb-4"
                ...
                {enabled && frequency !== 'never' && (
                    <Alert variant="info" className="mt-4">
                        ...
                        <div className="text-sm">
                            ...
                            <strong>{estimatedSize.toFixed(1)} GB</strong> of storage space for {retentionDays} days of backups.
                        </div>
                    </Alert>
                )}
            </div>
